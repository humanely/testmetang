...
var App = function() {
    ...
    var assetsPath = 'compatibility/assets/';
...
MetronicApp.controller('AppController', ['$scope', '$rootScope', function($scope, $rootScope) {
    $rootScope.$on('$viewContentLoaded', function(a,b,c) {
        b = a.targetScope;
        console.log('appc layouted',a.targetScope['$parent'] ,"      |     ",a['targetScope']['$parent'].value ,">");
        setTimeout(function(){
